...
// WA 4 times:
//  1) L33: compare with "nums[0]", NOT "nums[l]"!
//  2) L33: ">=", NOT ">". This really makes a difference. Think it over! Take [1,3] and [3,1] for example.
//  3) L17: "l<=r", NOT "l<r". Otherwise, the situation of nums[l] (=nums[r]) isn't processed.
//  4) L43: ">=0", NOT ">0".
